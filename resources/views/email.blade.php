  ...
  <tbody>
    <tr>
      <td><table width="600"  align="center" cellpadding="0" cellspacing="0">
          ...
          <tbody>
            <tr>
              <td><table bgcolor="#2D2E82" class="top" width="48%"  align="center" cellpadding="0" cellspacing="0" style="padding:10px 10px 10px 10px;">
                  <!-- First header column with Logo -->
                  <tbody>
                    <tr>
                      <td style="font-size: 18
								 px; color:#FFFFFF; text-align:center; font-family: sans-serif;">RED DE SALUD MACHALA</td>
                    </tr>
                  </tbody>
                </table>
</td>
            ...
            <tr>
              ...
              <td><table width="96%"  align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td align="center"bgcolor="#2D2E82" style="font-size: 32px; font-weight: 300; line-height: 2.5em; color: #FFFFFF; font-family: sans-serif;"style="padding:10px 10px 10px 10px;">AGENDA CITA MEDICA</td>
                  </tr>
                  <tr>
                    <!-- row container for Tagline -->
                    <td align="center" style="font-size: 16px; font-weight:300; color: #929292; font-family: sans-serif; padding-top: 20px">GENERACION DE CITAS MEDICAS POR APP </td>
                  </tr>
                  <tr>
                    <td style="font-size: 0; line-height: 0;" height="20"><table width="96%" align="left"  cellpadding="0" cellspacing="0">
                        <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" style="font-size: 14px; font-style: normal; font-weight: 100; color: #929292; line-height: 1.8; text-align:justify; padding:10px 20px 0px 20px; font-family: sans-serif;">La cita medica solicitada por {{$username}} para la fecha {{$fecha}} a las {{$hora}} en el centro de salud {{$nomb_centro_medico}} ha sido agendada con el medico {{$nomb_medico}} en la especialidad de {{$especialidad}} </td>
                  </tr>
                </table></td>
            </tr>
          </tbody>
